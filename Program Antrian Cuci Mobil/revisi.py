...
def start_program(): 
    ...
    def show_tambah_mobil_menu():
        ...
        def tambah_mobil_button_clicked():
            ...
            if mobil:  # Check if a car model is selected
                ...
                messagebox.showinfo("Sukses", f"Mobil {mobil} telah ditambahkan ke dalam antrian.")
            else:
                messagebox.showerror("Error", "Pilih sebuah mobil dari daftar atau masukkan mobil terlebih dahulu.")
    ...
    background_image = Image.open("./muti/background2.jpg")  # Replace "background_image.jpg" with your image file
